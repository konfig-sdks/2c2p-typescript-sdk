...
/**
 * This class provides a wrapper for network errors when making requests to PGW Payment API 4.3
 */
export class TwoCTwoPError extends Error {
  /**
   * The response body
   */
